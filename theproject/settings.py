...
SECRET_KEY = 'django-insecure-&lyavzq8un07px7502@udq_f^$j8u2m0*2!&weprtbum0(ci%4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['standing-notation.herokuapp.com', '127.0.0.1']

# fixes issue with force_str in Django 4
...
LOGIN_REDIRECT_URL = '/note/dashboard'
